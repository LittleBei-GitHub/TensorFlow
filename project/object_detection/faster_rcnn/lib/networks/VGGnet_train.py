...
class VGGnet_train(Network):
    def __init__(self, trainable=True):
        ...
        self.layers = dict({'data': self.data, 'im_info': self.im_info, 'gt_boxes': self.gt_boxes})  # 以字典方式给每层传数据
    ...
    def setup(self):
        ...
        # ========= RPN ============
        (self.feed('conv5_3')
         .conv(3, 3, 512, 1, 1, name='rpn_conv/3x3')  # same padding
        ...
        (self.feed('rpn_cls_prob_reshape', 'rpn_bbox_pred', 'im_info')  # 使用rpn的bbox预测结果去调整锚框
