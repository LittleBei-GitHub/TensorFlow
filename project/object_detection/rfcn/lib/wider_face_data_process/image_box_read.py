...
def parse_args():
    ...
    parser.add_argument('--base_data_url', dest='train_base_data',
                        help='train image base files',
                        default='/home/aurora/workspaces/data/WIDER_FACE/WIDER_train/images/', type=str)
    parser.add_argument('--file_dir', dest='image_file_dir',
                        help='train output data dir',
                        default='/home/aurora/workspaces/PycharmProjects/tensorflow/tf_rfcn/data/wider_face/image_event_dict_train.pkl',
                        type=str)
    parser.add_argument('--box_dir', dest='box_file_dir',
                        help='train output data dir',
                        default='/home/aurora/workspaces/PycharmProjects/tensorflow/tf_rfcn/data/wider_face/image_box_train_dict.pkl',
                        type=str)
