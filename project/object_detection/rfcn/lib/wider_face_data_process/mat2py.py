...
def parse_args():
    ...
    parser.add_argument('--mat_train', dest='mat_train_file',
                        help='train mat file',
                        default='/home/aurora/workspaces/data/WIDER_FACE/wider_face_split/wider_face_train.mat',
                        type=str)
    parser.add_argument('--mat_val', dest='mat_val_file',
                        help='validate mat file',
                        default='/home/aurora/workspaces/data/WIDER_FACE/eval_tools/ground_truth/wider_face_val.mat',
                        type=str)
    parser.add_argument('--mat_val_easy', dest='mat_val_easy',
                        help='val easy mat file',
                        default='/home/aurora/workspaces/data/WIDER_FACE/eval_tools/ground_truth/wider_easy_val.mat',
                        type=str)
    parser.add_argument('--mat_val_medium', dest='mat_val_medium',
                        help='val medium mat file',
                        default='/home/aurora/workspaces/data/WIDER_FACE/eval_tools/ground_truth/wider_medium_val.mat',
                        type=str)
    parser.add_argument('--mat_val_hard', dest='mat_val_hard',
                        help='val hard mat',
                        default='/home/aurora/workspaces/data/WIDER_FACE/eval_tools/ground_truth/wider_hard_val.mat',
                        type=str)
    parser.add_argument('--mat_test', dest='mat_test',
                        help='test mat',
                        default='/home/aurora/workspaces/data/WIDER_FACE/wider_face_split/wider_face_test.mat',
                        type=str)
    parser.add_argument('--train_image_url', dest='train_image_url',
                        help='train image url', default='/home/aurora/workspaces/data/WIDER_FACE/WIDER_train/images/',
                        type=str)
    parser.add_argument('--val_image_url', dest='val_image_url',
                        help='validate image url', default='/home/aurora/workspaces/data/WIDER_FACE/WIDER_val/images/',
                        type=str)
    parser.add_argument('--output_data_dir', dest='output_url',
                        help='train output data dir',
                        default='/home/aurora/workspaces/PycharmProjects/backup/tf-faster-rcnn/data/wider_face/',
                        type=str)
...
if __name__ == '__main__':
    ...
    mat_keys = ['invalid_label_list', 'occlusion_label_list', 'pose_label_list', 'blur_label_list', 'file_list',
                'event_list', 'face_bbx_list', 'illumination_label_list', 'expression_label_list']
