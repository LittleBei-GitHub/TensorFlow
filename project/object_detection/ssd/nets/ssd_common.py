...
def tf_ssd_bboxes_encode_layer(labels,
    ...
    def condition(i, feat_labels, feat_scores,
        ...
        """
        r = tf.less(i, tf.shape(labels))  # 比较两个数的大小
        return r[0]
    ...
    def body(i, feat_labels, feat_scores,
        ...
        mask = tf.greater(jaccard, feat_scores)  # 比较两个数的大小，返回true或false
        mask = tf.logical_and(mask, feat_scores > -0.5)  # 逻辑与
    ...
    feat_localizations = tf.stack([feat_cx, feat_cy, feat_w, feat_h], axis=-1)  # 压缩
