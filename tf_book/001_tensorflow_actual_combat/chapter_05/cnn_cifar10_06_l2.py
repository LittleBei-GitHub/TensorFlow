...
def TrainModel():
    ...
    with tf.Graph().as_default():
        ...
        summary_writer = tf.summary.FileWriter(logdir='evaluate_results/weights/L2_loss')
        ...
        with tf.Session() as sess:
            ...
            # 将评估结果保存到文件
            results_file = open('evaluate_results/weights/evaluate_results(L2_loss).csv', 'w', newline='')
