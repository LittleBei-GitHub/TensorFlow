...
def inception_v2_base(inputs,
    ...
    构建一个从输入到最终端点的inception v2网络
    This method can construct the network up to the layer inception(5b) as
    described in http://arxiv.org/abs/1502.03167.
    Args:
      inputs: a tensor of shape [batch_size, height, width, channels].
              一个形状为[batch_size, height, width, channels]的张量
            ...
            with tf.variable_scope(end_point):
                ...
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net, depth(64), [1, 1],
                        weights_initializer=trunc_normal(0.09), scope='Conv2d_0a_1x1')
                ...
                with tf.variable_scope('Branch_3'):
                    ...
                    branch_3 = slim.conv2d(branch_3, depth(32), [1, 1],
                        weights_initializer=trunc_normal(0.1), scope='Conv2d_0b_1x1')
...
def inception_v2(inputs,
    ...
    Args:
      inputs: a tensor of shape [batch_size, height, width, channels].
              形状为[batch_size, height, width, channels]的张量
      num_classes: number of predicted classes.
                   预测类别的数量
        If 0 or None, the logits layer is omitted and the input features to the logits layer (before dropout)
    ...
    with tf.variable_scope(scope, 'InceptionV2', [inputs], reuse=reuse) as scope:
        with slim.arg_scope([slim.batch_norm, slim.dropout], is_training=is_training):
            ...
            with tf.variable_scope('Logits'):
                ...
                # 1 x 1 x 1024
                net = slim.dropout(net, keep_prob=dropout_keep_prob, scope='Dropout_1b') # dropout
