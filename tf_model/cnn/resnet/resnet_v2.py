...
The full preactivation 'v2' ResNet variant implemented in this module was introduced by:
预激活形式的残差网络被提出在下面这篇论文
[2] Kaiming He, Xiangyu Zhang, Shaoqing Ren, Jian Sun
    Identity Mappings in Deep Residual Networks. arXiv: 1603.05027

The key difference of the full preactivation 'v2' variant compared to the
'v1' variant in [1] is the use of batch normalization before every weight layer.
v2和v1的关键不同之处在于v2在每层之前使用了BN
...
ResNet-101 for semantic segmentation into 21 classes:
   ...
   with slim.arg_scope(resnet_v2.resnet_arg_scope()):
      net, end_points = resnet_v2.resnet_v2_101(inputs, 21, is_training=False, global_pool=False, output_stride=16)
"""
