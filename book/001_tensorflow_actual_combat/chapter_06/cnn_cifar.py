...
dataset_dir_cifar10 = '../../cifar10_data'
dataset_dir_cifar100 = '../../cifar100_data'
...
def get_distorted_train_batch(cifar10or20or100, data_dir, batch_size):
    ...
    images, labels = cifar_input.distorted_inputs(cifar10or20or100=cifar10or20or100, data_dir=data_dir,
...
def get_undistorted_eval_batch(cifar10or20or100, data_dir, eval_data, batch_size):
    ...
    if cifar10or20or100 == 10:
        ...
        data_dir = os.path.join(data_dir, 'cifar-100-binary')
    images, labels = cifar_input.inputs(cifar10or20or100=cifar10or20or100, eval_data=eval_data, data_dir=data_dir,
                                        batch_size=batch_size)
    return images, labels
...
def Inference(image_holder):
    ...
    with tf.name_scope('Conv2d_1'):
        ...
        conv1_out = Conv2d(image_holder, weights, biases, stride=1, padding='SAME', activation=activation_func,
    ...
    with tf.name_scope('Conv2d_2'):
        ...
        conv2_out = Conv2d(pool1_out, weights, biases, stride=1, padding='SAME', activation=activation_func,
                           act_name=activation_name)
...
def TrainModel():
    ...
    with tf.Graph().as_default():
        ...
        with tf.name_scope('Inputs'):
            image_holder = tf.placeholder(tf.float32, [batch_size, image_size, image_size, image_channel],
                                          name='images')
        ...
        with tf.name_scope('GetTrainBatch'):
            image_train, labels_train = get_distorted_train_batch(cifar10or20or100=cifar10or20or100,
                                                                  data_dir=dataset_dir, batch_size=batch_size)

        # 定义获取测试样本批次的计算节点
        with tf.name_scope('GetTestBatch'):
            image_test, labels_test = get_undistorted_eval_batch(cifar10or20or100=cifar10or20or100,
                                                                 data_dir=dataset_dir, eval_data=True,
                                                                 batch_size=batch_size)
