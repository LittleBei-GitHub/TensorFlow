...
def inputs_origin(data_dir):
    ...
    # 我们应当这样理解reshaped_image：每次使用sess.run(reshaped_image)，就会从队列中取出一张图片
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        # 调用inputs_origin，传入cifar10数据集所在的目录
        reshaped_image = inputs_origin('/home/littlebei/Data/cifar10/cifar-10-batches-bin')
        # 执行start_queue_runners开启文件名队列
